    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method_payment', models.CharField(choices=[('Наличные', 'Наличные'), ('Перевод', 'Перевод')],
                                                    default='Наличные', verbose_name='Способ оплаты')),
                ...
                ('owner', models.ForeignKey(default=1,
                                            on_delete=django.db.models.deletion.CASCADE,
                                            related_name='owner_payments', to=settings.AUTH_USER_MODEL,
